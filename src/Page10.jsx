  ...
  const letterContent = (
    <div className="flex flex-col gap-4 text-[#3a2a1a] text-lg md:text-xl font-medium leading-relaxed text-left font-sans">
      ...
      <p>
        ...
        Pero seryoso Boss, hoping ako na sa susunod, malibot natin ang mga pasyalan dyan sa QC at yung mga napuntahan mo na. At soon, kung papayag ka... sa kinalakihan mo namang lugar tayo gagala, at ikaw naman din ang igagala ko dito sa lugar namin sa Tanza. Manifesting 'yan! ✨
      </p>
      ...
      <p>
        &nbsp; &nbsp; &nbsp; &nbsp; Tsaka yung voice mo... Sa tagal na nating naglalaro na naka-open mic at nag-v-vm, matagal ko nang gusto ko sabihin sa'yo na sobrang lambing. Di ko malaman kung bumagay ba sa pagiging maldita mo Boss, pero ang sarap pakinggan talaga lalo na nung nag-uusap tayo. For sure magaling ka kumanta noh? Sample nga ng isang <b>'Cruel Summer'</b> ni Taylor Swift dyan! 😝
      </p>
