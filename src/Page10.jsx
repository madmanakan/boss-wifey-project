...
function Page10({ onNext, onBack }) { 
  ...
  const letterContent = (
    <div className="flex flex-col gap-4 text-[#3a2a1a] text-lg md:text-xl font-medium leading-relaxed text-left font-sans">
      ...
      <p>
        &nbsp; &nbsp; &nbsp; &nbsp; Tsaka yung voice mo... sobrang lambing. Di ko malaman kung bumagay ba sa pagiging maldita mo Boss, pero ang sarap pakinggan talaga lalo na nung nag-uusap tayo. For sure magaling ka kumanta noh? Sample nga ng isang <b>'Cruel Summer'</b> ni Taylor Swift dyan! 😝
      </p>
